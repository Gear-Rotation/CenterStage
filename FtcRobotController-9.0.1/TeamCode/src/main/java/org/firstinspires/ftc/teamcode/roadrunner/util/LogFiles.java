...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = GearRotationMecanumDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = GearRotationMecanumDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = GearRotationMecanumDrive.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = GearRotationMecanumDrive.HEADING_PID.kP;
        public double mecHeadingI = GearRotationMecanumDrive.HEADING_PID.kI;
        public double mecHeadingD = GearRotationMecanumDrive.HEADING_PID.kD;
        public double mecLateralMultiplier = GearRotationMecanumDrive.LATERAL_MULTIPLIER;
